 ...
 */
#ifndef __DRIVERS_PINCTRL_MSM_H__
#define __DRIVERS_PINCTRL_MSM_H__

#include <dm/device.h>
#include <linux/types.h>

/**
 * struct msm_pin_desc - describes single pin
...
#define MSM_PINCTRL_PIN(a, b) { .number = a, .name = b }
#define MSM_PINCTRL_PIN_ANON(a) { .number = a }
 ...
 */
struct msm_pinctrl_soc_data {
	const struct msm_pin_desc *pins;
	unsigned npins;
...
/* defined in pinctrl-msm.c */
extern const struct pinctrl_ops msm_pinctrl_ops_dm;

int msm_pinctrl_probe2(struct udevice *dev,
		      const struct msm_pinctrl_soc_data *soc_data);
int msm_pinctrl_remove(struct udevice *dev);
