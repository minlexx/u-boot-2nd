...
static const struct msm_pin_desc sdm660_pins[] = {
	...
	MSM_PINCTRL_PIN(114, "SDC1_CLK"),
	MSM_PINCTRL_PIN(115, "SDC1_CMD"),
	MSM_PINCTRL_PIN(116, "SDC1_DATA"),
	MSM_PINCTRL_PIN(117, "SDC2_CLK"),
	MSM_PINCTRL_PIN(118, "SDC2_CMD"),
	MSM_PINCTRL_PIN(119, "SDC2_DATA"),
	MSM_PINCTRL_PIN(120, "SDC1_RCLK"),
};
...
static const struct msm_pinctrl_soc_data sdm660_pinctrl_data = {
	.pins = sdm660_pins,
...
{
	return msm_pinctrl_probe2(dev, &sdm660_pinctrl_data);
}
